...
import zm.hashcode.mshengu.client.web.content.fieldservices.servicerequest.forms.InnactiveServiceRequestForm;
import zm.hashcode.mshengu.client.web.content.fieldservices.servicerequest.models.ServiceRequestBean;
import zm.hashcode.mshengu.client.web.content.fieldservices.servicerequest.tables.InnactiveServiceRequestTable;
 ...
 * @author Ferox
 */
public class InnactiveServiceRequestTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {

    private final MshenguMain main;
    private final InnactiveServiceRequestForm form;
    private final InnactiveServiceRequestTable table;
    private UtilMethods utilMethods = new UtilMethods();
    private SendEmailHelper sendEmailHelper = new SendEmailHelper();

    public InnactiveServiceRequestTab(MshenguMain app) {
        main = app;
        form = new InnactiveServiceRequestForm();
        table = new InnactiveServiceRequestTable(main, this);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();
...
//            final ServiceRequestBean serviceRequestBean = getBean(serviceRequest);
    ...
    private void getHome() {
        getMain().content.setSecondComponent(new ServiceRequestMenu(getMain(), "CLOSED"));
    }

...
import zm.hashcode.mshengu.client.web.content.setup.locations.forms.RegionForm;
import zm.hashcode.mshengu.client.web.content.setup.locations.model.LocationBean;
import zm.hashcode.mshengu.client.web.content.setup.locations.tables.RegionTable;
 ...
 * @author Ferox
 */
public class RegionTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {
     
    
    private final MshenguMain main;
    private final RegionForm form;
    private final RegionTable table;

    public RegionTab(MshenguMain app) {
        main = app;
        form = new RegionForm();
        table = new RegionTable(main);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();
    ...
    private void getHome() {
        main.content.setSecondComponent(new LocationMenu(main, "REGION"));
    }
    ...
    private Location getLocation(LocationBean bean) {
        LocationType locationType = LocationTypeFacade.getLocationTypeService().findByName("REGION");

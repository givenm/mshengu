...
import zm.hashcode.mshengu.client.web.content.fieldservices.contactus.form.ContactUSForm;
import zm.hashcode.mshengu.client.web.content.fieldservices.contactus.models.ContactUSBean;
import zm.hashcode.mshengu.client.web.content.fieldservices.contactus.tables.ContactUSTable;
 ...
 * @author Ferox
 */
public class ActiveContactUSTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {

    private SendEmailHelper sendEmailHelper = new SendEmailHelper();
    private final MshenguMain main;
    private final ContactUSForm form;
    private final ContactUSTable table;
    private UtilMethods utilMethods = new UtilMethods();

    public ActiveContactUSTab(MshenguMain app) {
        main = app;
        form = new ContactUSForm();
        table = new ContactUSTable(main, this);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();

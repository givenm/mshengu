 ...
 * @author Luckbliss
 */
public class InnactiveContactUSFollowUpTab extends VerticalLayout implements
    ...
    public InnactiveContactUSFollowUpTab(MshenguMain app, final String id) {
        contactUSId = id;
        this.main = app;

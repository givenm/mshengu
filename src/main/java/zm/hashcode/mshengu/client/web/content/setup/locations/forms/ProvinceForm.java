...
public class ProvinceForm extends FormLayout {
    ...
    public ProvinceForm() {
        ...
        ComboBox parent = UIComboBox.getCountryLocationComboBox("Country :", "parent", LocationBean.class, binder);
        TextField name = UIComponent.getTextField("Province Name", "name", LocationBean.class, binder);

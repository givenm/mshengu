 ...
 * @author Luckbliss
 */
public class DocumentListTable extends Table {

    private final MshenguMain main;

    public DocumentListTable(MshenguMain main) {
        this.main = main;
        setSizeFull();
    ...
    public void loadDocumentCategories(List<Documents> set) {
        setNullSelectionAllowed(true);
        setSelectable(false);
        setImmediate(false);
        for (Documents d : set) {
            addItem(new Object[]{d.getName(),
                d.getCategory(),
                d.getDescription(),
                d.getUpload(),
                d.getUrl(),}, d.getId());

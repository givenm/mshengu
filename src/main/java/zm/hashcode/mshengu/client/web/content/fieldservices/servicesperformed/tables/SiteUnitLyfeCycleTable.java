 ...
 * @author Ferox
 */
public class SiteUnitLyfeCycleTable extends Table {
    ...
    public SiteUnitLyfeCycleTable(MshenguMain main) {
        this.main = main;
        setSizeFull();
            ...
            if (!StringUtils.isEmpty(siteUnit.getUnitLocationLifeCycle())) {
                for (UnitLocationLifeCycle unitLocationLifeCycle : siteUnit.getUnitLocationLifeCycle()) {
                    addItem(new Object[]{unitLocationLifeCycle.getSiteName(),
                        siteUnit.getUnitId(),
                        formatHelper.getYearMonthDay(unitLocationLifeCycle.getDateofAction()),

...
import zm.hashcode.mshengu.client.web.content.setup.locations.forms.SuburbForm;
import zm.hashcode.mshengu.client.web.content.setup.locations.model.LocationBean;
import zm.hashcode.mshengu.client.web.content.setup.locations.tables.SuburbTable;
 ...
 * @author Ferox
 */
public class SuburbTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {
     
    
    private final MshenguMain main;
    private final SuburbForm form;
    private final SuburbTable table;

    public SuburbTab(MshenguMain app) {
        main = app;
        form = new SuburbForm();
        table = new SuburbTable(main);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();
    ...
    private void getHome() {
        main.content.setSecondComponent(new LocationMenu(main, "SUBURB"));
    }
    ...
    private Location getLocation(LocationBean bean) {
        LocationType locationType = LocationTypeFacade.getLocationTypeService().findByName("SUBURB");

 ...
 * @author Ferox
 */
public class UnitToolsTab extends VerticalLayout implements
    ...
    public UnitToolsTab(MshenguMain app) {
        main = app;
...
//        addComponent(logo);
    ...
    private void getHome() {
        main.content.setSecondComponent(new AssetsMenu(main, "TOOLS"));
    }
}

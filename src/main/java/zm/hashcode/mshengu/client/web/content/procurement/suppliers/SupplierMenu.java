 ...
 */
package zm.hashcode.mshengu.client.web.content.procurement.suppliers;
...
import zm.hashcode.mshengu.client.web.content.procurement.suppliers.views.ServiceProviderProductCategoryTab;
import zm.hashcode.mshengu.client.web.content.procurement.suppliers.views.ServiceProviderProductDatabaseTab;
import zm.hashcode.mshengu.client.web.content.procurement.suppliers.views.ServiceProviderProductTab;

/**
 *
 * @author Ferox
 */
public class SupplierMenu extends VerticalLayout implements
    ...
    public SupplierMenu(MshenguMain app, String selectedTab) {
        main = app;

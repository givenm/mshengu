 ...
 * @author Ferox
 */
public class UnitMaintenanceTab extends VerticalLayout implements
    ...
    public UnitMaintenanceTab(MshenguMain app) {
        main = app;
...
//        addComponent(logo);
    ...
    private void getHome() {
        main.content.setSecondComponent(new AssetsMenu(main, "MAINTENANCE"));
    }
}

...
import zm.hashcode.mshengu.client.web.content.fieldservices.contactus.views.InnactiveContactUSFollowUpTab;
 ...
 * @author Ferox
 */
public class InnactiveContactUSTable extends Table {
    ...
    public InnactiveContactUSTable(final MshenguMain main, final InnactiveContactUSTab tab) {
        this.main = main;
        setSizeFull();
...
//        addContainerProperty("Closed ", Embedded.class, null);
        ...
        // Add Data Columns
        List<ContactUS> contactUSList = ContactUSFacade.getContactUSService().findAllClosed();
        for (ContactUS contactUS : contactUSList) {
                ...
                followUpButton.addClickListener(new Button.ClickListener() {  
                    ...
                    public void buttonClick(Button.ClickEvent event) {
                        ...
                        InnactiveContactUSFollowUpTab form = new InnactiveContactUSFollowUpTab(main, contactUSId);

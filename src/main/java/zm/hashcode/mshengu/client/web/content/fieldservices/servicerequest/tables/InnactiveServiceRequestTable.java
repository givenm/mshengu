...
import zm.hashcode.mshengu.client.web.content.fieldservices.servicerequest.views.InnactiveServiceRequestFollowUpTab;
 ...
 * @author Ferox
 */
public class InnactiveServiceRequestTable extends Table {
    ...
    public InnactiveServiceRequestTable(final MshenguMain main, final InnactiveServiceRequestTab tab) {
        this.main = main;
        setSizeFull();
...
//        addContainerProperty("Email", String.class, null);
        ...
        // Add Data Columns
        List<ServiceRequest> serviceRequestList = ServiceRequestFacade.getServiceRequestService().findAllClosed();
        for (ServiceRequest serviceRequest : serviceRequestList) {
            ...
            followUpButton.addClickListener(new Button.ClickListener() {
                ...
                public void buttonClick(Button.ClickEvent event) {
                    ...
                    InnactiveServiceRequestFollowUpTab form = new InnactiveServiceRequestFollowUpTab(main, incidentId);

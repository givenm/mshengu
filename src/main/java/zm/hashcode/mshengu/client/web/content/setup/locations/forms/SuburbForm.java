 ...
 * @author boniface
 */
public class SuburbForm extends FormLayout {
    ...
    public SuburbForm() {
        ...
        ComboBox parent = UIComboBox.getRegionsLocationComboBox("Region :", "parent", LocationBean.class, binder);
        TextField name = UIComponent.getTextField("Suburb Name", "name", LocationBean.class, binder);

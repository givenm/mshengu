 ...
 */
package zm.hashcode.mshengu.client.web.content.setup.officeutils.contracttype.views;
 ...
 * @author Ferox
 */
public class ContractTypeTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {

    private final MshenguMain main;
    private final ContractTypeForm form;
    private final ContractTypeTable table;

    public ContractTypeTab(MshenguMain app) {
        main = app;
        form = new ContractTypeForm();
        table = new ContractTypeTable(main);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();

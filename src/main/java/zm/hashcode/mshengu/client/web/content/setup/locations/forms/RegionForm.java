...
public class RegionForm extends FormLayout {
    ...
    public RegionForm() {
        ...
        ComboBox parent = UIComboBox.getProvinceLocationComboBox("Province :", "parent", LocationBean.class, binder);
        TextField name = UIComponent.getTextField("Region Name", "name", LocationBean.class, binder);

 ...
 * @author Luckbliss
 */
public class InnactiveServiceRequestFollowUpTab extends VerticalLayout implements
    ...
    public InnactiveServiceRequestFollowUpTab(MshenguMain app, final String id) {
        serviceRequestId = id;
        this.main = app;
...
//            final ServiceRequestFollowUpBean followUpBean = getBean(userAction);
    ...
    private void getHome() {
        main.content.setSecondComponent(new ServiceRequestMenu(main, "CLOSED"));
    }

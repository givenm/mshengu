 ...
 * @author Colin
 */
public class ServiceFleetThreeMonthlyEfficiencyBean implements Serializable, Comparable<ServiceFleetThreeMonthlyEfficiencyBean> {
    ...
    @Override
    public int compareTo(ServiceFleetThreeMonthlyEfficiencyBean o) {

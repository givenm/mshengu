 ...
 * @author Ferox
 */
public class UnitRepairsTab extends VerticalLayout implements
    ...
    public UnitRepairsTab(MshenguMain app) {
        main = app;
...
//        addComponent(logo);
    ...
    private void getHome() {
        main.content.setSecondComponent(new AssetsMenu(main, "LANDING"));
    }
}

 ...
 * @author Ferox
 */
public class CustomerSiteUnitForm2 extends FormLayout {
    ...
    public CustomerSiteUnitForm2() {
        ...
        comboBoxSelectUnit = new ComboBox("Unit");
        ...
        grid.addComponent(comboBoxSelectUnit, 2, 0);
    ...
    public void loadSiteUnits(Set<SiteUnit> siteUnitList) {
        ...
        for (SiteUnit siteUnit : siteUnitList) {
            ...
            comboBoxSelectUnit.setItemCaption(siteUnit.getId(), siteUnit.getId());
        }
    }
}

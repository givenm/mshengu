...
import zm.hashcode.mshengu.client.web.content.fieldservices.incidents.tables.IncidentTable;
 ...
 * @author Ferox
 */
public class ActiveIncidentsTab extends VerticalLayout implements
        Button.ClickListener, Property.ValueChangeListener {

    private final MshenguMain main;
    private final IncidentForm form;
    private final IncidentTable table;
    private UtilMethods utilMethods = new UtilMethods();
    private SendEmailHelper sendEmailHelper = new SendEmailHelper();

    public ActiveIncidentsTab(MshenguMain app) {
        main = app;
        form = new IncidentForm();
        table = new IncidentTable(main, this);
        setSizeFull();
        addComponent(form);
        addComponent(table);
        addListeners();
...
//        final Status status = StatusFacade.getStatusService().findById(incidentBean.getStatus());
    ...
    private void getHome() {
        main.content.setSecondComponent(new IncidentMenu(main, "LANDING"));
    }
